...
// Prevent hydration mismatch by only checking isMobile after mount
const isMounted = ref(false)
onMounted(() => {
  isMounted.value = true
})

const showMobileSidebar = computed(() => isMounted.value && isMobile.value)
</script>
...
<template>
  ...
  <Sheet v-else-if="showMobileSidebar" :open="openMobile" v-bind="$attrs" @update:open="setOpenMobile">
